...
function releaseSuppressionForFreshInput(event) {
  ...
  // Keep blocking the synthetic click generated by the same gesture that
  // closed the landing cover, but allow a genuinely new tap on the app or
  // first-entry picker immediately instead of swallowing it for 350ms.
...
// A real second interaction has its own pointer/touch start. Clear the
// ghost-click window before that interaction's click is generated.
